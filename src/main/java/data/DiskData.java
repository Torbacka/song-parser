...
public class DiskData {
    private List<DiskSong> songs = new ArrayList<>();

    public List<DiskSong> getSongs() {
        return songs;
    }
    ...
    private void init() {
        ...
        songs.add(new DiskSong(
                ...
                ""));
        songs.add(new DiskSong("Cykelhandlarens visa", "", "", "Åh, hoj!", ""));
        songs.add(new DiskSong(
                "Tjugotre",
        ...
        songs.add(new DiskSong(
                ...
                ""));
        songs.add(new DiskSong("Sjömannens visa", "", "", "Åh, boj!", ""));
        songs.add(new DiskSong(
                "O.P. river",
                "Melodi: Ol' man river",
                "",
        ...
        songs.add(new DiskSong(
                ...
                ""));
        songs.add(new DiskSong("Vad blåser det för vind idag?", "", "",
        ...
        songs.add(new DiskSong(
                ...
                ""));
        songs.add(new DiskSong("Regissörens skål", "", "", "Tystnad... Tagning!",
                ""));
        songs.add(new DiskSong(
                "Sista supen",
                "Melodi: Väva vadmal",
                ...
                ""));
        songs.add(new DiskSong("Titta taket", "", "", "Titta, taket!", ""));
        songs.add(new DiskSong("Farväl, farväl",
        ...
        songs.add(new DiskSong("Jag äter inte klockor",
        ...
        songs.add(new DiskSong(
                ...
                ""));
        songs.add(new DiskSong(
                "Programmer's Drinking DiskSong",
                "",
                "",
